...
public:
    conges();
    conges(const QString &id, const QString &unite, const QString &nom, const QString &prenom, const QString &njc, const QString &njcpadresse, const QString &njcf, const QString &njcr, const QString &njcm);
