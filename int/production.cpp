...
void production::afficher_combo_boc_reclamation()
{
    QSqlQuery qry;
...
void production::on_aj_triggered()
{
...
void production::on_mo_triggered()
{
    QString id = ui->lineEdit->text();
    QString model = ui->lineEdit_2->text();
    QString carb = ui->carbedit->text();
...
void production::on_tableView_activated(const QModelIndex &index)
    {
...
void production::on_su_triggered()
...
void production::on_act_triggered()
{
    ui->tableView->setModel(tmpcmd.afficher());//refresh
                ui->lineEdit->clear();
                ui->lineEdit_2->clear();
...
void production::on_st_triggered()
...
void production::on_lineEdit_4_textChanged(const QString &arg1)
{
    QSqlQueryModel *model= new QSqlQueryModel();
            QSqlQuery   *query= new QSqlQuery();
...
void production::on_actionajout_triggered()
{
...
void production::on_actionmodif_triggered()
{
...
void production::on_tableView_2_activated(const QModelIndex &index)
{
    {
...
void production::on_actionsupp_triggered()
{
    QString id_r = ui->lineEdit_5->text();
...
void production::on_actiontri_triggered()
{
    QSqlQueryModel *model= new QSqlQueryModel();
            QSqlQuery   *query= new QSqlQuery();
...
void production::on_lineEdit_6_textChanged(const QString &arg1)
{
    QSqlQueryModel *model= new QSqlQueryModel();
            QSqlQuery   *query= new QSqlQuery();
