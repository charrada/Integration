...
void gemp::on_pushButton_12_clicked()// ajouter conge
{
...
void gemp::on_pushButton_11_clicked()
{
...
void gemp::on_pushButton_13_clicked()//modifier conge
{
...
void gemp::on_pushButton_14_clicked()// recherchefil modifier
{
    QString id = ui->lineEdit_35->text();
           QSqlQuery query;
...
void gemp::on_pushButton_8_clicked()// ajou empl
{
...
void gemp::on_tabWidget_3_currentChanged(int index)// affich employe
{
    if ( index == 0){
...
void gemp::on_pushButton_9_clicked()// supp fil employe
{
...
void gemp::on_pushButton_15_clicked()// recherch fil mod employe
{
...
void gemp::on_pushButton_10_clicked()
{
...
void gemp::on_tabWidget_2_currentChanged(int index)
{
    if ( index == 1){
...
void gemp::on_pushButton_7_clicked()
{
