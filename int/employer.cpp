...
{
    ui->setupUi(this);
    ui->le_unitee_2->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->le_nom->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->le_prenomm_2->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_10->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_14->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_5->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_6->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_13->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_11->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_12->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_25->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_26->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
    ui->lineEdit_27->setValidator(new QRegExpValidator( QRegExp("[A-Za-z ]*"), this ));
...
void employer::on_pushButton_12_clicked()// ajouter conge
{
...
void employer::on_pushButton_11_clicked()
{
    ui->tableView_2->setModel(conge.tri1());
}

void employer::on_pushButton_6_clicked() // supp conge
{
...
void employer::on_pushButton_13_clicked()//modifier conge
{
...
void employer::on_pushButton_14_clicked()// recherchefil modifier
{
    QString id = ui->lineEdit_35->text();
           QSqlQuery query;
...
void employer::on_pushButton_8_clicked()// ajou empl
{
...
void employer::on_tabWidget_3_currentChanged(int index)// affich employe
{
    if ( index == 0){
...
void employer::on_pushButton_9_clicked()// supp fil employe
{
...
void employer::on_pushButton_15_clicked()// recherch fil mod employe
{
...
void employer::on_pushButton_10_clicked()
{
...
void employer::on_tabWidget_2_currentChanged(int index)
{
    if ( index == 1){
...
void employer::on_pushButton_7_clicked()
{
